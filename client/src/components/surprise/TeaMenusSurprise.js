    ...
    <>
      {Object.keys(groupedBevList).map((type, index) => {
        ...
        if (filteredList.length > 0) {
          return (
            <Container fluid className="menu__box-surprise" key={index}>
              <h3 className="type-menu-surprise">{type}</h3>
...
export default TeaMenusSurprise;